...
import 'package:nyro/utils/validators.dart';
...
abstract class LinkParser {
  static String generateSubShareLink(String url, [String? name]) {
    ...
    // return 'nyro://import/$modifiedUri';
    return '$modifiedUri';
  }

  // protocols schemas
  static const protocols = ['nyro', 'hiddify', 'v2ray', 'v2rayn', 'v2rayng', 'clash', 'clashmeta', 'sing-box'];
