...
import 'package:nyro/core/utils/ip_utils.dart';
...
const Map<String, OrgIconData> organizationData = {
  ...
  "azure": OrgIconData(FluentIcons.cloud_24_filled, Color(0xff0078d4)),
  "amazon": OrgIconData(FluentIcons.cloud_24_filled, Color(0xffff9900)),
  "oracle": OrgIconData(FluentIcons.cloud_24_filled, Color(0xfff80000)),
