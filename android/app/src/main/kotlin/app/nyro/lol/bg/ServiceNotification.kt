...
import app.nyro.lol.Application
import app.nyro.lol.MainActivity
import app.nyro.lol.R
import app.nyro.lol.Settings
import app.nyro.lol.constant.Action
import app.nyro.lol.constant.Status
//import app.nyro.lol.utils.CommandClient
import com.hiddify.core.libbox.Libbox
import app.nyro.lol.Application.Companion.notification
import app.nyro.lol.utils.GrpcClientProvider
    ...
    fun show(profileName: String, @StringRes contentTextId: Int) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Application.notification.createNotificationChannel(
                NotificationChannel(
                    notificationChannel, "nyro service", NotificationManager.IMPORTANCE_LOW
                )
            )
        }
        service.startForeground(
            notificationId, notificationBuilder
                .setContentTitle(profileName.takeIf { it.isNotBlank() } ?: "Nyro")
