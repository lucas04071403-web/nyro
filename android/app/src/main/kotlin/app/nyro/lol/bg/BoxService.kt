...
import app.nyro.lol.constant.Alert
...
import app.nyro.lol.BuildConfig
import app.nyro.lol.MainActivity
import app.nyro.lol.constant.Bugs
            ...
            val newService = try {
                Mobile.setup(
                    SetupOptions().also {
                        ...
                        it.fixAndroidStack = app.nyro.lol.bg.Bugs.fixAndroidStack
